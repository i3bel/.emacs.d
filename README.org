...
#+begin_src emacs-lisp 
  (use-package centaur-tabs
    ...
    :init
    (defun centaur-tabs-enable-once-hook ()
      (centaur-tabs-mode 1)
      (remove-hook 'buffer-list-update-hook #'centaur-tabs-enable-once-hook))
    :hook (buffer-list-update-hook . centaur-tabs-enable-once-hook)
    :config
