  ...
  (use-package modus-themes
    ...
    (setq modus-themes-common-palette-overrides
          '((bg-main "#0f0b14")
            ...
            (bg-region "#2b2240")
            (bg-visual "#2b2240")
            (bg-visual-alt "#1c2638")
            (bg-paren-match "#2f2b40")
            (fg-paren-match "#f6c7a1")
            (bg-search-current "#3b2e4f")
            (bg-search-lazy "#2c3b44")
            (bg-search-replace "#443128")
            (bg-completion "#1c1428")
            (bg-completion-match-0 "#2b2240")
            (bg-completion-match-1 "#24324a")
            (bg-completion-match-2 "#2c3a3a")
            (bg-completion-match-3 "#3a2a3a")
            (bg-line-number-active "#241c39")
            (fg-line-number-active "#f4f0ff")
            (bg-line-number-inactive "#0d0a12")
            (fg-line-number-inactive "#6f648c")
            (bg-mode-line-active "#241c39")
            (fg-mode-line-active "#f4f0ff")
            (bg-mode-line-inactive "#161023")
            (fg-mode-line-inactive "#a99ec2")
            (border-mode-line-active "#f6c7a1")
            (border-mode-line-inactive "#211a33")
            (bg-diff-added "#123226")
            (bg-diff-changed "#2b2f40")
            (bg-diff-removed "#361f2b")
