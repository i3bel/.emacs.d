...
#+begin_src emacs-lisp 
  ...
  ;; start a bit later and process in larger chunks to avoid CPUスパイク
...
#+begin_src emacs-lisp 
  (use-package emojify
    :ensure t
    :config
    :hook (window-setup-hook . (lambda () (run-with-idle-timer 1.0 nil #'global-emojify-mode))))
#+end_src
...
#+begin_src emacs-lisp
  (use-package lambda-line
    :ensure t
    :hook (window-setup-hook . (lambda () (run-with-idle-timer 0.8 nil #'lambda-line-mode)))
    :config
...
#+begin_src emacs-lisp 
  (use-package centaur-tabs
    :ensure t
    :hook (window-setup-hook . (lambda () (run-with-idle-timer 0.3 nil #'centaur-tabs-mode)))
    :config
...
#+begin_src emacs-lisp 
  (use-package dashboard
    :ensure t
    :commands (open-dashboard dashboard-open)
    :config
    ...
    (run-with-idle-timer 0.7 nil #'open-dashboard)
...
#+begin_src emacs-lisp
  (use-package dirvish
    :ensure t
    :after nerd-icons
    :hook (dired-mode-hook . dirvish-override-dired-mode)
    :config
...
#+begin_src emacs-lisp
  (use-package puni
    :ensure t
    :hook ((window-setup-hook . (lambda () (run-with-idle-timer 0.6 nil #'puni-global-mode)))
...
#+begin_src emacs-lisp
  (use-package which-key
    :ensure t
    :hook (window-setup-hook . (lambda () (run-with-idle-timer 0.4 nil #'which-key-mode))))
#+end_src
...
#+begin_src emacs-lisp
  (use-package elcord
    :ensure t
    :hook (window-setup-hook . (lambda () (run-with-idle-timer 1.2 nil #'elcord-mode))))
#+end_src
