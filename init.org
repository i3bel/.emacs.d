...
#+begin_src emacs-lisp 
  (use-package centaur-tabs
    ...
    :init
    (defvar my/centaur-tabs--post-start-hook-set nil)
    (defun my/centaur-tabs-start ()
      (remove-hook 'post-command-hook #'my/centaur-tabs-start)
      (setq my/centaur-tabs--post-start-hook-set nil)
      (unless (featurep 'centaur-tabs)
        (require 'centaur-tabs))
      (unless centaur-tabs-mode
        (centaur-tabs-mode 1)))
    (unless my/centaur-tabs--post-start-hook-set
      (add-hook 'post-command-hook #'my/centaur-tabs-start)
      (setq my/centaur-tabs--post-start-hook-set t))
    :config
