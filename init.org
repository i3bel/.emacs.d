...
#+begin_src emacs-lisp 
  (use-package centaur-tabs
    ...
    :init
    (defvar my/centaur-tabs--idle-start-timer nil)
    (defun my/centaur-tabs-start ()
      (when my/centaur-tabs--idle-start-timer
        (cancel-timer my/centaur-tabs--idle-start-timer)
        (setq my/centaur-tabs--idle-start-timer nil))
    ...
    (add-hook
     'emacs-startup-hook
     (lambda ()
       (unless my/centaur-tabs--idle-start-timer
         (setq my/centaur-tabs--idle-start-timer
               (run-with-idle-timer 1.0 nil #'my/centaur-tabs-start)))))
    :config
