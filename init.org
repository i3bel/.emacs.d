...
**** dashboard
#+begin_src emacs-lisp 
  (defvar my/dashboard-startup-time nil)

  (defun my/dashboard-init-info ()
    "Return startup time measured when the dashboard is first rendered."
    (unless my/dashboard-startup-time
      (setq my/dashboard-startup-time
            (float-time (time-subtract (current-time) before-init-time))))
    (format "Emacs started in %.3f seconds" my/dashboard-startup-time))
