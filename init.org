...
*** secret
#+begin_src emacs-lisp :tangle no
  (when (file-exists-p (locate-user-emacs-file "secret.el"))
    (load "secret.el"))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-<left>") 'my/centaur-tabs-forward)
  (global-set-key (kbd "C-<right>") 'my/centaur-tabs-backward)
...
*** save-place-mode
#+begin_src emacs-lisp 
  (use-package save-place-mode :hook (window-setup-hook . save-place-mode))
#+end_src

*** electric-pair-mode
#+begin_src emacs-lisp 
  (use-package electric-pair-mode :hook (window-setup-hook . electric-pair-mode))
#+end_src
...
#+begin_src emacs-lisp
  (use-package delete-selection-mode :hook (window-setup-hook . delete-selection-mode))
#+end_src
...
#+begin_src emacs-lisp
  (use-package auto-revert-mode
    :hook (window-setup-hook . global-auto-revert-mode)
    :config
...
#+begin_src emacs-lisp 
  (use-package emojify
    ...
    :init
    (defvar my/emojify--idle-start-timer nil)
    (defun my/emojify-start ()
      (when my/emojify--idle-start-timer
        (cancel-timer my/emojify--idle-start-timer)
        (setq my/emojify--idle-start-timer nil))
      (global-emojify-mode 1))
    (add-hook
     'emacs-startup-hook
     (lambda ()
       (unless my/emojify--idle-start-timer
         (setq my/emojify--idle-start-timer
               (run-with-idle-timer 1.5 nil #'my/emojify-start)))))
    :config)
#+end_src
...
#+begin_src emacs-lisp
  (use-package lambda-line
    :ensure t
    :hook (window-setup-hook . lambda-line-mode)
    :config
...
#+begin_src emacs-lisp
  (use-package modus-themes
    ...
    :hook (window-setup-hook . (lambda () (load-theme 'modus-vivendi t))))
#+end_src
...
#+begin_src emacs-lisp 
  (use-package page-break-lines
    :ensure t
    :hook (window-setup-hook . global-page-break-lines-mode))
#+end_src
...
#+begin_src emacs-lisp 
  (use-package centaur-tabs
    ...
    :init
    (defvar my/centaur-tabs-started nil)

    (defun my/centaur-tabs-ensure-mode ()
      (unless my/centaur-tabs-started
        (require 'centaur-tabs)
        (centaur-tabs-mode 1)
        (setq my/centaur-tabs-started t)))

    (defun my/centaur-tabs-enable ()
      (interactive)
      (my/centaur-tabs-ensure-mode))

    (defun my/centaur-tabs-forward ()
      (interactive)
      (my/centaur-tabs-ensure-mode)
      (call-interactively 'centaur-tabs-forward))

    (defun my/centaur-tabs-backward ()
      (interactive)
      (my/centaur-tabs-ensure-mode)
      (call-interactively 'centaur-tabs-backward))
    :config
...
#+begin_src emacs-lisp
  (use-package corfu
    ...
    :hook (window-setup-hook . global-corfu-mode)
    :config
    (setopt corfu-auto t)
...
#+begin_src emacs-lisp 
  (use-package dashboard
    :ensure t
    :init
    (defvar my/dashboard--idle-start-timer nil)
    (defun my/dashboard-start ()
      (when my/dashboard--idle-start-timer
        (cancel-timer my/dashboard--idle-start-timer)
        (setq my/dashboard--idle-start-timer nil))
      (open-dashboard))
    (add-hook
     'emacs-startup-hook
     (lambda ()
       (unless my/dashboard--idle-start-timer
         (setq my/dashboard--idle-start-timer
               (run-with-idle-timer 0.5 nil #'my/dashboard-start)))))
    :config
...
#+begin_src emacs-lisp
  (use-package vertico
    :ensure t
    :hook (window-setup-hook . vertico-mode))
#+end_src
...
#+begin_src emacs-lisp
  (use-package elcord
    :ensure t
    :hook (window-setup-hook . elcord-mode))
#+end_src
