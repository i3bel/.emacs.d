  ...
  (use-package modus-themes
    ...
    (setq modus-themes-common-palette-overrides
          '((bg-main "#151025")
            ...
            (bg-region "#2f2946")
            (bg-visual "#2f2946")
            (bg-visual-alt "#242e42")
            (bg-paren-match "#322c46")
            (fg-paren-match "#f6c7a1")
            (bg-search-current "#3f3155")
            (bg-search-lazy "#2f3f4a")
            (bg-search-replace "#46352c")
            (bg-completion "#201832")
            (bg-completion-match-0 "#2f2946")
            (bg-completion-match-1 "#28354f")
            (bg-completion-match-2 "#304042")
            (bg-completion-match-3 "#3f2f43")
            (bg-line-number-active "#2a2340")
            (fg-line-number-active "#f7f3ff")
            (bg-line-number-inactive "#151025")
            (fg-line-number-inactive "#8c82a8")
            (bg-mode-line-active "#2a2340")
            (fg-mode-line-active "#f7f3ff")
            (bg-mode-line-inactive "#1b1630")
            (fg-mode-line-inactive "#b6abc9")
            (border-mode-line-active "#f6c7a1")
            (border-mode-line-inactive "#251f3a")
